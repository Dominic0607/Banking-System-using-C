...
void new_acc() // NEW ACCOUNT FUNCTION

{
    int choice;
    FILE *ptr;
    ptr = fopen("C:\\Users\\gurve\\OneDrive\\Desktop\\Shary\\Mini Project in C Bank Management System.txt", "wt");
...
void close() //THIS FUNCTION WILL CLOSE THE PROGRAM AND WILL PRINT CLOSING STATEMENT
{
    system("color 2");
    printf("\n\n\n\n\t\t\t\tThis C Mini Project is developed by Sukhpreet Singh!\n\n\n\n");
}

//THIS FUNCTION WILL SHOW THE MENU FOR  USER TO CHOOSE OPTIONS
